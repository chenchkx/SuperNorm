...
from modules.convlayer.graphsage_layer import GraphSageLayer
...
class GraphSage_Graph(nn.Module):
    def __init__(self, embed_dim, output_dim, num_layer, args):
        super(GraphSage_Graph, self).__init__()
        ...
        for i in range(num_layer):
            self.conv_layers.append(GraphSageLayer(embed_dim, embed_dim, econv=args.econv))
...
### GraphSage Network for Node Property Prediction
class GraphSage_Node(nn.Module):
    def __init__(self, input_dim, embed_dim, output_dim, num_layer, args):
        ...
        self.node_encoder = GraphSageLayer(input_dim, embed_dim)
...
### GraphSage Network for Link Property Prediction
class GraphSage_Link(nn.Module):
    def __init__(self, input_dim, embed_dim, output_dim, num_layer, args):
        super(GraphSage_Link, self).__init__()
    ...
    def forward(self, graph, nfeat, efeat=None, edge_weight=None):
        ...
        # initializing node features h_n and edge features h_e
        h_n = self.node_encoder(graph, nfeat)
